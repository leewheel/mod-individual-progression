...
REPLACE INTO `creature_queststarter` (`id`, `quest`) VALUES (4968, 11222);
REPLACE INTO `creature_queststarter` (`id`, `quest`) VALUES (1748, 11223);
...
REPLACE INTO `creature_questender` (`id`, `quest`) VALUES (1748, 11222);
REPLACE INTO `creature_questender` (`id`, `quest`) VALUES (4968, 11223);
...
REPLACE INTO `gossip_menu_option` (`MenuID`, `OptionID`, `OptionIcon`, `OptionText`, `OptionBroadcastTextID`, `OptionType`, 
